...
export const iconBtn =
  "rounded p-2 text-th-fg-m transition hover:bg-th-subtle hover:text-th-fg";

export const iconBtnDanger =
  "rounded p-2 text-th-fg-m transition hover:bg-red-500/10 hover:text-red-400";

export const cardCls = "rounded-xl border border-th-border bg-th-panel/80 p-6";

export const overlayCls =
  "fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm";

export const modalCls =
  "w-full max-w-sm rounded-xl border border-th-border bg-th-panel p-6 shadow-2xl";
