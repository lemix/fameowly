...
/** Load rotation state from disk (called once at startup) */
...
/** Ensure flush timer is running (every 30 seconds) */
 ...
 * Returns the key string and advances the counter.
 */
